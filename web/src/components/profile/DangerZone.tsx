...
/**
 * The only thing here is the erase, y alcanza: borrar todo deja el navegador
 * como recién llegado, así que también es la forma de rehacer la configuración
 * inicial. Un botón aparte para eso decía lo mismo dos veces.
 */
